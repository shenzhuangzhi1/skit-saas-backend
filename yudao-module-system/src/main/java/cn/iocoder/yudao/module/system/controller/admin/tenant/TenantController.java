...
public class TenantController {
    ...
    @PreAuthorize("@systemPlatformAdminGuard.isPlatformAdmin() and @ss.hasPermission('system:tenant:query')")
    ...
    @PreAuthorize("@systemPlatformAdminGuard.isPlatformAdmin() and @ss.hasPermission('system:tenant:export')")
